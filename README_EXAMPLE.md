...
_Integration to integrate with [mawaqeet][mawaqeet]._
...
1. In the `custom_components` directory (folder) create a new folder called `mawaqeet`.
1. Download _all_ the files from the `custom_components/mawaqeet/` directory (folder) in this repository.
1. Place the files you downloaded in the new directory (folder) you created.
1. Restart Home Assistant
1. In the HA UI go to "Configuration" -> "Integrations" click "+" and search for "Mawaqeet"
